package app.skripsi.aspinkepumas.ui.grafik;
...
public class GrafikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AnyChartView GrafikView = findViewById(R.id.chart_grafik);
        GrafikView.setProgressBar(findViewById(R.id.chart_progressbar));
        ...
        cartesian.title("Grafik Variabel Kepuasan Mahasiswa Terhadap Layanan Tahun :");

        cartesian.yAxis(0).title("Hasil");
